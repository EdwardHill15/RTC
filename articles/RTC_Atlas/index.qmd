...
execute: 
  ...
  message: false
---
![Picture of RTC Atlas of Resonance Theory of Consciousness](atlas.png)
<!-- ```{css} -->
<!-- /* styles.css - Light Blue Theme Overrides */ -->
<!-- body { -->
...
<!-- .quarto-title-banner { -->
<!--   background-color: #BBDEFB;             /* Slightly darker title banner */ -->
<!--   color: #0D47A1;                       /* Deep blue title text */ -->
<!-- } -->

<!-- .content { -->
<!--   background-color: rgba(227, 242, 253, 0.95);  /* Semi-transparent light blue */ -->
